      ...
      <div className="min-h-0 overflow-y-auto p-5">
        ...
        <section className="rounded-xl border border-cs2-border bg-cs2-surface-1/50 p-4">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <button type="button" disabled={Boolean(busy)} onClick={() => void run("regen", () => liteCutClient.regenerateProxyCache())} className="rounded-md border border-cs2-accent/40 bg-cs2-accent-soft px-2.5 py-1.5 text-[11px] font-semibold text-cs2-accent disabled:opacity-50">{busy === "regen" ? "正在加入队列…" : "重新生成全部代理"}</button>
