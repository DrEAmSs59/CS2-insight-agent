        ...
        >
          ...
          {(activeTab === "general" || activeTab === "paths") && (
            <div className="space-y-4">
              ...
              {activeTab === "paths" && (
              <SectionCard title={t("settings.sectionPaths")} hint={t("settings.sectionPathsHint")} search={search && !matches(t("settings.sectionPaths") + " " + t("settings.labelCs2Path") + " " + t("settings.labelLiteCutStorage") + " " + t("settings.labelDataDirectory"))}>
